...
jpeg("R_analysis/rarefaccio1.jpeg", quality = 100)
rarecurve(otu_rare, step = 100, label = T, col = rainbow(nrow(otu_rare)))
dev.off()
```
...
jpeg("R_analysis/rarefaccio2.jpeg", quality = 100)
rarecurve(otu_rare2, step = 100, label = T, col= rainbow(nrow(otu_rare2)))
dev.off()
```
